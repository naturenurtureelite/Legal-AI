...
last2=0.0
#a=["gist"]
#a=["BERT","Summarunner_AttnRNN","Summarunner_CNN_RNN","Summarunner_RNN_RNN"]
...
if sys.argv[1]=="unsupervised_domain_independent":
	...
	a=["Summarunner_AttnRNN","Summarunner_CNN_RNN","Summarunner_RNN_RNN","gist","BERT"]
	...
	a=["BERT","CaseSummarizer","gist","DELSumm","DSDR","KMM","LetSum","LexRankSummarizer","LsaSummarizer","LuhnSummarizer","MMR","ReductionSummarizer","Summarunner_AttnRNN","Summarunner_CNN_RNN","Summarunner_RNN_RNN"]
elif sys.argv[1]=="top_4":
	a=["Summarunner_AttnRNN","Summarunner_RNN_RNN","BERT","DELSumm"]
...
for i in range(0,50):
	...
	for j in range(0,len(a)):
			...
			for x1 in range(0,len(v6)):
				...
				#print(pos)
				maxi=-1.0
				count[pos]=count[pos]+(1.000000/float(count_borda))
