...
import shutil
shutil.remove("unordered/empty.txt")
shutil.remove("ordered/empty.txt")
...
a=[sys.argv[1]]
#a=["BERT","ChineseGist","SummaRuNNer/AttnRNN_F7_avr","SummaRuNNer/RNN_RNN_F7_avr","SummaRuNNer/CNN_RNN_F7_avr"]
